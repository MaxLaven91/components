...
export const categories: Category[] = [
  ...
  },
  {
    id: "sidebars",
    label: "Sidebars",
    description: "Navigation sidebars with icons, groups, and collapsible layouts",
    sort: 7,
  },
];
...
export const blocks: Block[] = [
  ...
  // Tables
  {
    ...
    tags: ["table", "data", "minimal"],
    registryDependencies: ["card", "table"],
    dependencies: [],
    component: () => import("./blocks/tables/table-01"),
  },
  {
    id: "table-02",
    category: "tables",
    ...
    tags: ["table", "status", "actions", "dropdown"],
    registryDependencies: ["card", "table", "badge", "button", "dropdown-menu"],
    dependencies: ["lucide-react"],
    component: () => import("./blocks/tables/table-02"),
  },
  {
    id: "table-03",
    category: "tables",
    ...
    dependencies: ["lucide-react"],
    component: () => import("./blocks/tables/table-03"),
  },
  {
    id: "table-04",
    category: "tables",
    ...
    dependencies: [],
    component: () => import("./blocks/tables/table-04"),
  },
  {
    id: "table-05",
    category: "tables",
    ...
    tags: ["table", "search", "pagination", "checkbox"],
    registryDependencies: ["card", "table", "input", "button", "checkbox", "badge"],
    dependencies: [],
    component: () => import("./blocks/tables/table-05"),
  },
  ...
  // Sidebars
  {
    ...
    tags: ["sidebar", "navigation", "icons"],
    registryDependencies: ["button", "separator"],
    dependencies: ["lucide-react"],
    component: () => import("./blocks/sidebars/sidebar-01"),
  },
  {
    id: "sidebar-02",
    category: "sidebars",
    ...
    tags: ["sidebar", "navigation", "groups", "badges"],
    registryDependencies: ["button", "separator", "badge"],
    dependencies: ["lucide-react"],
    component: () => import("./blocks/sidebars/sidebar-02"),
  },
  {
    id: "sidebar-03",
    category: "sidebars",
    ...
    tags: ["sidebar", "navigation", "collapsible", "tooltip"],
    registryDependencies: ["button", "separator", "tooltip"],
    dependencies: ["lucide-react"],
    component: () => import("./blocks/sidebars/sidebar-03"),
  },
  {
    id: "sidebar-04",
    category: "sidebars",
    ...
    tags: ["sidebar", "navigation", "profile", "avatar"],
    registryDependencies: ["button", "separator", "avatar", "badge"],
    dependencies: ["lucide-react"],
    component: () => import("./blocks/sidebars/sidebar-04"),
  },
];
